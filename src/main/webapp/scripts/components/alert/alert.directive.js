        ...
        return {
            ...
            controller: ['$scope',
                function($scope) {
                    ...
                    var cleanHttpErrorListener = $rootScope.$on('coursetrackerApp.httpError', function (event, httpResponse) {
                        var i;
                        ...
                        switch (httpResponse.status) {
                            ...
                            case 400:
                                var errorHeader = httpResponse.headers('X-coursetrackerApp-error');
                                var entityKey = httpResponse.headers('X-coursetrackerApp-params');
                                if (errorHeader) {
